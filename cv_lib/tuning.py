...
import cv2
import numpy as np
from src.rs_camera import Camera
...
def tune():
    ...
    img_path = '/home/phil/Documents/Projects/CV_SLAM_project/data/flowers/test1.jpg'
    depth_path = '/home/phil/Documents/Projects/Data_stats/flower/depth/pic4_depth.jpg'
    color_img = cv2.imread(img_path)
    depth_img = cv2.imread(depth_path)
    create_hsv_trackbar(color_img)
